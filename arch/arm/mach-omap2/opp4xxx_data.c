...
#define OMAP4430_VDD_MPU_OPPNITROSB2_UV		1417960
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE_NVALUE(OMAP4430_VDD_MPU_OPPNITROSB2_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP, 12319980),
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	/* MPU OPP1 - OPP25 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 180000000, OMAP4430_VDD_MPU_OPP25_UV),
	/* MPU OPP2 - OPP50 */
	...
	/* MPU OPP8 - OPP-NITROSBPLUS */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1380000000, OMAP4430_VDD_MPU_OPPNITROSB_UV),
	/* MPU OPP9 - OPP-NITROSB2 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1400000000, OMAP4430_VDD_MPU_OPPNITROSB2_UV),
	/* L3 OPP1 - OPP50 */
